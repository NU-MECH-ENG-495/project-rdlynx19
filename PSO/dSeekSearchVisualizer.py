...
# Animation function
def update(frame, positions, global_best_positions, grid_best_positions, scat, best_scat, grid_scat, fitness_line, global_best_fitness, ax1):
    ...
    return scat, best_scat, grid_scat, fitness_line
...
def visualize_particle_positions(filename):
    ...
    ani = animation.FuncAnimation(
        ...
        fargs=(positions, global_best_positions, grid_best_positions, scat, best_scat, grid_scat, fitness_line, global_best_fitness, ax1),
